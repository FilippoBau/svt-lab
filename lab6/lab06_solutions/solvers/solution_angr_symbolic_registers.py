...
def main(argv):
  path_to_binary = '../target/angr_symbolic_registers'
  ...
  # (!)
  start_address = 0x080488b2  # :integer (probably hexadecimal)
  ...
  if simulation.found:
    ...
    solution = hex(solution0)[2:] + ' ' + hex(solution1)[2:] + ' ' + hex(solution2)[2:]  # :string
    print(solution)
  else:
