...
def main(argv):
  path_to_binary = '../target/angr_symbolic_memory'
  ...
  # (!)
  password0_address = 0x9413560
  initial_state.memory.store(password0_address, password0)
  password1_address = 0x9413568
  initial_state.memory.store(password1_address, password1)
  password2_address = 0x9413570
  initial_state.memory.store(password2_address, password2)
  password3_address = 0x9413578
